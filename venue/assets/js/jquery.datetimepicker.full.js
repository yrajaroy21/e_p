			...
			calendar
				.on('touchend click.xdsoft', 'td', function (xdevent) {
					...
					if (options.onSelectDate &&	typeof options.onSelectDate === 'function') {
						var setM = $this.data('month') + 1;
						var newdate = $this.data('year')+"-"+setM+"-"+$this.data('date');
						options.onSelectDate.call(datetimepicker, newdate, datetimepicker.data('input'), xdevent);
					}
