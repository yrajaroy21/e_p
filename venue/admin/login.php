...
<body>
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <fieldset>
                  ...
                  <input type="text" name="adminemail" id="adminemail" pattern="[^ @]*@[^ @]*" placeholder="Your E-mail..." required="">
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
  ...
  <script>
        document.getElementById("bt_adminlogin").addEventListener("click", function () {
    ...
    document.getElementById("bt_adminlogin").addEventListener("click", function () {
      ...
      if (adminEmail === "" || adminPassword === "") {
        ...
        // For now, simply redirect to a placeholder "next-page.php"
