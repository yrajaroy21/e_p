            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <fieldset>
                  ...
                  <input type="text" name="organizeremail" id="organizeremail" pattern="[^ @]*@[^ @]*" placeholder="Your E-mail..." required="">
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
                  <label for="subject">Password</label>
                  <input type="password" name="organizerpassword" id="organizerpassword" placeholder="password" >
                </fieldset>
              </div>
              
              <div class="col-lg-12">
                <fieldset>
                  <button type="button" id="bt_organizerlogin" class="orange-button">Login</button>
                </fieldset>
              </div>
            </div>
          </form>
